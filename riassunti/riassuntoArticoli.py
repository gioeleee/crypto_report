...
BASE_URL = input("Inserisci l'URL base dell'API (es: https://1a30971073ef.ngrok-free.app): ").strip()
API_URL = BASE_URL + "/generate_summaries/"
...
# Estrae articoli da riassumere, esegue fino a 3 tentativi di chiamata API e salva i risultati o 'NESSUN CONTENUTO' in caso di errore.
